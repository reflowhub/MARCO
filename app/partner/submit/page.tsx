...
const GRADING_STEPS: GradingStep[] = [
  ...
  },
  {
    ...
    description: "Examples: cracks, broken glass, dead areas, coloured lines, severe screen defects.",
  ...
  },
  {
    ...
    description: "Examples: bent frame, major dents, broken back glass, missing parts, severe corner damage.",
  ...
  },
  {
    ...
    description: "Examples: faulty buttons, charging problems, speaker or microphone faults, camera issues, poor battery performance.",
  ...
  },
  {
    ...
    description: "Examples: deep scratches, noticeable dents, heavy scuffing, worn edges or substantial surface marks.",
  ...
  },
  {
    ...
    description: "Examples: light scratches, small scuffs or minor marks from normal use.",
